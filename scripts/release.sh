...
#
# CI then builds Linux amd64/arm64, Windows amd64 (private WSL runtime), and
# source artifacts, publishes them to a GitHub Release, and uploads the
# self-update src/ manifest.
