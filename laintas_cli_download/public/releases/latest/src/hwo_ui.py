...
_STYLE = Style.from_dict({
    "header":          "bold #7aa2f7",
    "header.name":     "bold #c0caf5",
    "running":         "bold #e0af68",
    "agent.spin":      "#e0af68",
    "agent.name":      "bold #bb9af7",
    "agent":           "",
    "task.run":        "#7aa2f7",
    "task.done":       "#9ece6a",
    "task.err":        "bold #f7768e",
    "task.pend":       "#6b7280",
    "task.text":       "#c0caf5",
    "separator":       "bold #5a7bbf",
    "dim":             "#6b7280",
    "help":            "#6b7280 italic",
    "input.prefix":    "bold #9ece6a",
    "scrollbar.thumb": "bold #7aa2f7",
    "scrollbar.rail":  "#3b4261",
})
